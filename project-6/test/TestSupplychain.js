...
contract('SupplyChain', function(accounts) {
    ...
    it("Testing smart contract function processItem() that allows a farmer to process coffee", async() => {
        ...
        let txProcess = await supplyChain.processItem(upc, {
            from: originFarmerID
        })
        ...
        truffleAssert.eventEmitted(txProcess, 'Processed');
    })
    ...
    it("Testing smart contract function packItem() that allows a farmer to pack coffee", async() => {
        ...
        // Mark an item as Packed by calling function processtItem()
        let txPack = await supplyChain.packItem(upc, {
            from: originFarmerID,
        })
        ...
        truffleAssert.eventEmitted(txPack, 'Packed');
    ...
    it("Testing smart contract function sellItem() that allows a farmer to sell coffee", async() => {
        ...
        let txSell = await supplyChain.sellItem(upc, productPrice, {
            from: originFarmerID,
        })
        ...
        truffleAssert.eventEmitted(txSell, 'ForSale');
    ...
    it("Testing smart contract function buyItem() that allows a distributor to buy coffee", async() => {
        ...
        let txBuy = await supplyChain.buyItem(upc, {
            from: distributorID,
        ...
        truffleAssert.eventEmitted(txBuy, 'Sold');
    ...
    it("Testing smart contract function shipItem() that allows a distributor to ship coffee", async() => {
        ...
        let txShip = await supplyChain.shipItem(upc, {
            from: distributorID,
        })
        ...
        truffleAssert.eventEmitted(txShip, 'Shipped');
    ...
    it("Testing smart contract function receiveItem() that allows a retailer to mark coffee received", async() => {
        ...
        let txRecieveItem = await supplyChain.receiveItem(upc, {
            from: retailerID,
        })
        ...
        truffleAssert.eventEmitted(txRecieveItem, 'Received');
    ...
    it("Testing smart contract function purchaseItem() that allows a consumer to purchase coffee", async() => {
        ...
        let txPurchaseItem = await supplyChain.purchaseItem(upc, {
            from: consumerID,
        })
        ...
        truffleAssert.eventEmitted(txPurchaseItem, 'Purchased');
